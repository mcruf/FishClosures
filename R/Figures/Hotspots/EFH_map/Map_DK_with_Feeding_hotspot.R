...
# Adult feeding ground shapefiles
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
setwd("~/Desktop/Review_FR/R2/Results/Hotspot/Feeding/Adults/")
sbox1 <- readOGR(".", "Adult_feeding_box1")
sbox2 <- readOGR(".", "Adult_feeding_box2")
sbox3 <- readOGR(".", "Adult_feeding_box3")
...
# Juvenile feeding hotspot shapefiles
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
setwd("~/Desktop/Review_FR/R2/Results/Hotspot/Feeding/Recruits/")
rbox1 <- readOGR(".", "Recruits_feeding_box1")
rbox2 <- readOGR(".", "Recruits_feeding_box2")
...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
srbox <- readOGR("~/Desktop/Review_FR/R2/Results/Hotspot/Feeding/", "Adult_Recruit_feeding_intersection")
crs(srbox) <- "+proj=laea +lat_0=52 +lon_0=10 +x_0=4321000 +y_0=3210000 +ellps=GRS80 +units=m +no_defs" 
...
geom_polygon(data = sbox1DF, aes(x = long, y = lat, group = group),fill="tan", colour="black", alpha=0.6) +
  geom_polygon(data = sbox2DF, aes(x = long, y = lat, group = group),fill="tan", colour="black", alpha=0.6) +
  geom_polygon(data = sbox3DF, aes(x = long, y = lat, group = group),fill="tan", colour="black", alpha=0.6) +
  
  
  geom_polygon(data = rbox1DF, aes(x = long, y = lat, group = group),fill="mediumseagreen", colour="black", alpha=0.6) +
  geom_polygon(data = rbox2DF, aes(x = long, y = lat, group = group),fill="mediumseagreen", colour="black", alpha=0.6) +
  ...
  annotate(geom = "text", x = 12.75, y = 55.8, label = "FGA1",
           fontface = "bold", color = "grey10", size = 6) +
  
  annotate(geom = "text", x = 13.83, y = 55.27, label = "FGA2",
           fontface = "bold", color = "grey10", size = 6) +
  
  # annotate(geom = "text", x = 13.75, y = 55.55, label = "FGA2",
  #          fontface = "bold", color = "grey10", size = 6) +
  # 
  # geom_segment(aes(x = 13.75, y = 55.5, xend = 13.75, yend = 55.2),
  #              lineend = "butt",
  #              linejoin = "round",
  #              size = 1,
  ...
  annotate(geom = "text", x = 14.00, y = 54.7, label = "FGA3",
         fontface = "bold", color = "grey10", size = 6) +
  
  geom_segment(aes(x = 14.35, y = 54.7, xend = 14.8, yend = 54.7),
               lineend = "butt",
               linejoin = "round",
               size = 1,
               arrow = arrow(length = unit(0.5, "cm"))) +
  ...
  ##Feeding grounds
  annotate(geom = "text", x = 14.73, y = 55.85, label = "FGJ1",
           fontface = "bold", color = "grey10", size = 6) +
  
  geom_segment(aes(x = 14.55, y = 55.8, xend = 14.55, yend = 55.45),
               lineend = "butt",
               linejoin = "round",
               size = 1,
               arrow = arrow(length = unit(0.5, "cm"))) +
  ...
  annotate(geom = "text", x = 15.1, y = 54.9,label = "FGJ2",
           fontface = "bold", color = "grey10", size = 6) +
  ...
  #              arrow = arrow(length = unit(0.5, "cm"))) +
  # 
  # annotate(geom = "text", x = 14.08, y = 54.9, label = "FGJ4",
  #          fontface = "bold", color = "grey10", size = 4) +
  # 
  # 
  # annotate(geom = "text", x = 14.75, y = 54.73, label = "FGJ3",
  #          fontface = "bold", color = "grey10", size = 4) +
  ...
  labs(x = "Longitude (°)", y="Latitude (°)", title = 'Feeding Area Closures (Juveniles & Adults)') +
...
ggsave("DK_map_Closures_feeding_grounds.png",dpi=450, width = 25, height = 35, units = "cm")
